...
I have not taken any steps to secure this repo from harm as the repo contains nothing personal to me that would be at risk of being lost. Any data deleted can be reaccessed through the original repo this has been cloned from, and as work is submitted on a weekly basis, issues won't arise from corruption.
